...
function Footer() {
    return (
        <footer>
            <div className="container grid-wrapper clear-row-gap">
                <div className="col-d-4 col-m-expand">
                ...
                <div className="col-d-2 m-hidden">
                    <strong className="text-small mb-s block">خدمات درمانیتو</strong>
                    <ul className="navbar-list">
                        <li>
                            <Link to="/" title="داروخانه آنلاین">داروخانه آنلاین</Link>
                        </li>
                        <li>
                            <Link to="/" title="فروشگاه آنلاین">فروشگاه آنلاین</Link>
                        </li>
                        <li>
                            <Link to="/" title="ویزیت آنلاین">ویزیت آنلاین</Link>
                        </li>
                        <li>
                            <Link to="/" title="پرونده پزشکی">پرونده پزشکی</Link>
                        </li>
                    </ul>
                </div>
                <div className="col-d-2 m-hidden">
                    ...
                    <ul className="navbar-list">
                        <li>
                            <Link to="/contacts" title="تماس با ما">تماس باما</Link>
                        </li>
                        <li>
                            <Link to="/about" title="درباره ما">درباره ما</Link>
                        </li>
                        <li>
                            <Link to="/faq" title="سوالات متداول">سوالات متداول</Link>
                        </li>
                        <li>
                            <Link to="/rules" title="قوانین و شرایط">قوانین و شرایط</Link>
                        </li>
                    </ul>
                </div>
                <div className="col-d-4 m-hidden">
                    <strong className="text-small mb-s block">دانلود درمانیتو</strong>
                    <ul className="btn-group">
                        <li>
                            <a href="/" title="" class="btn btn-dark flex flex-justify-center">
                                <img src={Bazzar} alt="" />
                            </a>
                        </li>
                        <li>
